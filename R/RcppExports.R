...
smc_plans <- function(N, l, counties, pop, n_distr, wc, tol, gamma, log_prob, thresh, alpha, infl = 5L, verbosity = 1L) {
    .Call(`_redist_smc_plans`, N, l, counties, pop, n_distr, wc, tol, gamma, log_prob, thresh, alpha, infl, verbosity)
}
